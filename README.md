...
[WisNodeV1.1 Arduino Library](https://github.com/RAKWireless/WisNode-Arduino-Library/tree/master/Documents and tools/WisNodeV1.1 Arduino Library)

If you are using RAK811 WisNode in V1.2 version, please download RAK811 WisNode through this link:

[WisNodeV1.2 Arduino Library](https://github.com/RAKWireless/WisNode-Arduino-Library/tree/master/Documents and tools/WisNodeV1.2 Arduino Library)
...
[RAK811 WisNode V1.1 Hardware](https://github.com/RAKWireless/WisNode-Arduino-Library/blob/master/Documents and tools/WisNodeV1.1 Arduino Library/RAK811 WisNode V1.1 Hardware.md)

If your Version of RAK WisNode is V1.2, see how to connect in this link:

[RAK811 WisNode V1.2 Hardware](https://github.com/RAKWireless/WisNode-Arduino-Library/blob/master/Documents and tools/WisNodeV1.2 Arduino Library/RAK811 WisNode V1.2 Hardware.md)
